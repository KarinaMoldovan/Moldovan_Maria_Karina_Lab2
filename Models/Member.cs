...
namespace Moldovan_Maria_Karina_Lab2.Models
{
    public class Member
    {
        ...
        [RegularExpression(@"^0[0-9]{3}[-. ]?[0-9]{3}[-. ]?[0-9]{3}$", ErrorMessage = "Telefonul trebuie să înceapă cu cifra '0' și să fie de forma '0722-123-123', '0722.123.123' sau '0722 123 123'.")]
